...
define(["underscore", "jquery", "when", "meld", "wire/lib/object", "core/utils/surrogate/ClonedCollection", "kefir", "kefirJquery"], function(_, $, When, meld, object, ClonedCollection, Kefir, KefirJquery) {
  ...
  return function(options) {
    ...
    cloneStructureFactory = function(resolver, compDef, wire) {
      return wire(compDef.options).then(function(structure) {
        ...
        removers.push(meld.afterReturning(structure, "addSource", function(source) {
