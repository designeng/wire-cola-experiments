define ->
    ...
    controller:
        ...
        properties:
            townsListView               : {$ref: 'townsListView'}
            townsCollection             : {$ref: 'townsCollection'}
            townsCollectionSource       : {$ref: 'townsCollectionSource'}

            namesListView               : {$ref: 'namesListView'}
            namesCollection             : {$ref: 'namesCollection'}
            namesCollectionSource       : {$ref: 'namesCollectionSource'}
        ready:
            "onReady": {}
    ...
    namesCollection:
        create:
            module: 'cola/Collection'
        # ready:
        #     "addSource": {$ref: "namesCollectionSource"}
